...
import com.bennero.client.pages.WelcomePage;
import com.bennero.common.TransitionType;
import javafx.scene.Node;

/**
 * State data for the Welcome Page. WelcomePageStateData is a subclass of StateData, it stores information about the
 ...
 * @since       1.0
 */
public class WelcomePageStateData extends StateData
{
    private static final String NAME = "WELCOME_PAGE";

    public WelcomePageStateData()
    {
