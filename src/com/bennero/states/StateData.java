...
/**
 * State data is designed to be a base class for objects that store the state of the application. StateData sub classes
 * contain information on the current state so that graphical user interface components can be created and destroyed on
