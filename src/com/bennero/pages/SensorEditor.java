...
import static com.bennero.ui.UIHelper.*;
...
public class SensorEditor extends BorderPane
{
    ...
    private VBox interchangableEditOptions;
    ...
    public SensorEditor(PageData pageData, Sensor sensor, StateData backButtonState)
    {
        ...
        interchangableEditOptions = new VBox();
    ...
    {
        editOptions.getChildren().remove(interchangableEditOptions);
        interchangableEditOptions = new VBox();
        editOptions.getChildren().add(interchangableEditOptions);
    ...
    private void addAverageUI(Sensor sensor)
    {
        ...
        interchangableEditOptions.getChildren().add(averageOption);
        interchangableEditOptions.getChildren().add(colourOptions);
        interchangableEditOptions.getChildren().add(averagePeriodGroup);
    }
    ...
    private void addThresholdUI(Sensor sensor)
    {
        ...
        interchangableEditOptions.getChildren().add(colourOptions);
        interchangableEditOptions.getChildren().add(thresholdValueGroup);
    }
